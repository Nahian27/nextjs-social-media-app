        ...
        <div className="max-w-xs mx-auto grow -mt-24">
          ...
          <Card noPadding={true}>
            <div className="rounded-md">
              ...
              <Link href="/" className="flex gap-4 items-center justify-center p-4 border-b border-b-slate-700 hover:bg-socialBlue hover:text-white hover:border-b-socialBlue hover:rounded-md hover:shadow-md hover:  transition-all hover:scale-110">
              ...
              <Link href="/" className="flex gap-4 items-center justify-center p-4  hover:bg-socialBlue hover:text-white hover:border-b-socialBlue hover:rounded-md hover:shadow-md hover:  transition-all hover:scale-110">
